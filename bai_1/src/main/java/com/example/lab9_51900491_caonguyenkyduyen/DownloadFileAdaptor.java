package com.example.lab9_51900491_caonguyenkyduyen;
...
public class DownloadFileAdaptor  extends RecyclerView.Adapter<DownloadFileAdaptor.MyViewHolder>{
    ...
    public DownloadFileAdaptor(Handler handler, int mPosition, Context context, List<DownloadFile> mDownloadedFileList) {
        this.handler = handler;
        this.mPosition = mPosition;
        this.context = context;
        this.mDownloadedFileList = mDownloadedFileList;
    }
